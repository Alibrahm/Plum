...
import ffIcon  from "../../images/plumlogo.svg";
...
export default function AddToMobileFirefox(props: Props) {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 h-[60%] z-50 pb-12 px-4 text-white">
            <div className="relative bg-[#522080a1] p-4 h-full rounded-xl flex flex-col justify-around items-center text-center">
                <button className="absolute top-0 right-0 p-3" onClick={closePrompt}>
                    <FaTimes className="text-2xl" />
                </button>
                <p className="text-lg">For the best experience, we recommend installing the Plum Finance app to your home screen!</p>
